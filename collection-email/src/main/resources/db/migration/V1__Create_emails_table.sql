create schema if not exists collection_emails;

create table collection_emails.emails(
...
create table collection_emails.emails_confirmation(
  confirmation_id bigint primary key,
  email_id bigint REFERENCES collection_emails.emails(email_id),
